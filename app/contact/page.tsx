...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contact Weiyu Dang about AI systems, creative tools, and research workflows."
};
      ...
      <section className="section">
        <div className="container grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-start">
          <div>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              {contactTopics.map((topic) => (
                <div key={topic} className="panel-quiet p-4 text-sm font-semibold text-slate-700">
                  {topic}
                </div>
              ))}
            </div>
          ...
          <aside className="panel p-6">
            <Mail className="text-[#f4b740]" size={28} aria-hidden />
            <h2 className="mt-4 text-2xl font-semibold text-slate-950">Email</h2>
            ...
            <div className="mt-6 rounded-[8px] border border-emerald-200/60 bg-emerald-50 p-4 text-sm leading-6 text-emerald-800">
