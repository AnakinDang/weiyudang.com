...
export const tradingViews = ["Today", "Signals", "Desks", "Options Lab", "Evidence", "Replay", "System"] as const;
...
export const tradingTodayFocus = [
  {
...
export const tradingOptionsLab = [
  {
...
export const tradingOpenQuestions = [
...
export const tradingSystemStatus = [
  {
...
export const tradingUnavailableActions = [
  "Order placement",
  "Broker write",
  "Paper submit",
  "Live submit",
